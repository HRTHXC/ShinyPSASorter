...
plantedPreCalc <- 0
outputString <- ""
meanColumnNames <- paste("Father Name", "PSA Death", "Planted", "Average Alive")
...
for(i in 1:fatherUniques){
  ...
  outputString[i] <- paste(fatherName[i], psaDeath, planted, lifeRate, sep = ":")
  fatherNameMeanTable <- matrix(outputString, nrow=fatherLength-1, ncol=4, dimnames = list(fatherName, meanColumnNames))
